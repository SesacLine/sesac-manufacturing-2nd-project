...
| `kg_rca/` | 지식그래프(KG). 도메인 문헌 → Neo4j 적재 → LLM KG 추출 → 결정적 그래프 순회로 원인 후보(`hypotheses.json`) 생성 | 완성, 계속 갱신 중(v2.4) |
...
- 그래프 스키마(v2.5, 정본 `docs/KG_schema_v1.3.md` — 07-22 신설, v1.2는 v2.4 기록용): 노드 8종
...
- **⚠️ 기획안이 낡은 구간**: `docs/semiconductor_proposal.md` §6.2는 아직 "문헌 5편 → 청크 95개 →
  ...
  정본은 `kg_rca/STATUS.md` §1과 `docs/KG_schema_v1.3.md`** — 기획안 수치를 인용하지 말 것.
...
| KG 스키마 전체 명세(정본) | `docs/KG_schema_v1.3.md` (v2.5, 07-22 신설 — v1.2는 v2.4 기록용) |
